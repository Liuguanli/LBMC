...
class DeepDeterministicPolicyGradient():
    def __init__(self, action_dim, state_dim, action_bound, LR_A, LR_C, REPLACEMENT, GAMMA, EPSILON=0.9,
                 MEMORY_CAPACITY=1000, OUTPUT_GRAPH=False, BATCH_SIZE=32):
    ...
    def choose_action(self, observation,  force_random=False):
        if np.random.uniform() < self.EPSILON and not force_random:
