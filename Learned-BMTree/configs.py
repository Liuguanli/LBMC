...
def set_config():
    ...
    parser.add_argument('--file_time', help='file time', type=int, default=1)
    ...
    parser.add_argument('--train_query', help='which query workload to use, (uniform, normal, skew, design)',
                        default='skew_1000_dim2')
    ...
    parser.add_argument('--page_size', help='the number of data records per block', type=int, default=100)
    ...
    parser.add_argument('--is_opt_cost', help='the password of the dbsystem', type=int, default=1)
    parser.add_argument('--exp_query_file', help='which query workload to use, (uniform, normal, skew, design)',
                        default='skew_1000_dim2')
